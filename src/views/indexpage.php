...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <a href="indexpage.php" class="inline-flex items-center justify-center h-20 w-20 bg-purple-600 hover:bg-purple-500 focus:bg-purple-500">
  ...
  <div class="flex-grow text-gray-800">
    ...
    <?php 
    $sql1 = "SELECT * FROM Article a left join Archive r on a.Id_Article = r.Id_Article where  r.Id_Article is null order by a.Id_Article desc";
